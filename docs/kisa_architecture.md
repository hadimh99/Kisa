...
Translating *Basa'ir al-Darajat* (al-Ṣaffār) into the Hadith Library so it reads exactly like al-Kāfi. **Chapter 1 (Part 1, 5 narrations) is done and live in the reader; this is a pilot before scaling the full book (~899 pages / ~1,800 narrations).**
...
- **Progress:** **Part 1 Ch 1 (5 narrations) + Ch 2 (16) = 21 done and live-rendering**, all unified under the conventions above. Part 1 has 24 chapters; the book has ~10 parts (~1,800 narrations). **Next: Ch 3** ("Recognition of the Scholar…", PDF p.26+) — but only on the user's say-so; user wants to commit + push Ch 1–2 to production first (to tease the new book).
