...
| Transcript Library | `TranscriptLibrary.jsx` | 90 KB | Scholarly reading, export, native scrolling, Contextual Bridge integration |
...
| Server (Node.js) | `server.js` | 23 KB | Express API: Dual search, Ontology, K-Means, Gemini, /api/ontology |
